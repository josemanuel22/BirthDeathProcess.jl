...
Use Runge Kutta pairs of orders 5 and 4 methods for solving the solution of
the Initial Value Problem of birth and death process process determined by
the parameters β and δ. The ODE that determine the problem is n' = β - δ * n.
...
Use dynamic stochastic algorithm (dynamic monte-carlo) for solving the
solution of the Initial Value Problem of birth and death process process.
...
([1.0693425409298716, 1.1801284254628217 … 19.901058921300237],
 [1.0, 1.8564632373325913 … 9.999991209587657]) 
"""
